...
ps.clean.t0 = readRDS("phyloseq.cleanest.t0.rds")
seqtab.clean.t0 <- data.frame(ps.clean.t0@otu_table)
samdf.clean.t0 <- data.frame(ps.clean.t0@sam_data)

ps.clean.prestress = readRDS("phyloseq.cleanest.prestress.rds")
...
ps.trim.rare.t0 = readRDS("phyloseq.t0.trim.rarefied.1k.rds")
seqtab.trim.rare.t0 <- data.frame(ps.trim.rare.t0@otu_table)
samdf.trim.rare.t0 <- data.frame(ps.trim.rare.t0@sam_data)

ps.trim.rare.prestress = readRDS("phyloseq.prestress.trim.rarefied.1k.rds")
...
load("ps.clean.t0.Rdata")
load("ps.clean.prestress.Rdata")

load("ps.rare.t0.Rdata")
load("ps.rare.prestress.Rdata")

load("ps.trim.rare.t0.Rdata")
load("ps.trim.rare.prestress.Rdata")

load("ps.trim.t0.Rdata")
load("ps.trim.prestress.Rdata")
