...
# lineage      1  1.549  1.5492   2.371  0.131
# Residuals   45 29.403  0.6534               
...
summary(a.div.ps) 
#             Df Sum Sq Mean Sq F value Pr(>F)
# lineage      1   1.05   1.050   0.962   0.33
# treat        1   1.01   1.006   0.922   0.34
# Residuals   81  88.40   1.091               
```
...
summary(a.div) 
#             Df Sum Sq Mean Sq F value Pr(>F)  
# lineage      1   5406    5406   3.053 0.0874 .
# Residuals   45  79686    1771                 
...
summary(a.div) 
#             Df Sum Sq Mean Sq F value Pr(>F)
# lineage      1     93   93.31   0.316  0.576
# treat        1    108  108.08   0.366  0.547
# Residuals   81  23945  295.61               
```
...
```{r richness stats}
#otu richness
shapiro.test(df.t0.div$Observed) #fine
leveneTest(df.t0.div$Observed~lineage,data=df.t0.div) #fine

a.div <- aov(Observed~lineage,data=df.t0.div)
summary(a.div) 
#             Df  Sum Sq Mean Sq F value Pr(>F)
# lineage      1    8431    8431   0.355  0.554
# Residuals   45 1068211   23738               

a.div <- aov(Observed~lineage+treat,data=df.ps.div)
summary(a.div) 
#             Df  Sum Sq Mean Sq F value Pr(>F)  
# lineage      1       9       9   0.001 0.9786  
# treat        1   66991   66991   5.402 0.0226 *
# Residuals   81 1004539   12402                 
```
...
summary(a.div) 
#             Df Sum Sq  Mean Sq F value Pr(>F)  
# lineage      1 0.0294 0.029432   3.716 0.0602 .
# Residuals   45 0.3564 0.007919                 

a.div <- aov(even~lineage+treat,data=df.ps.div)
summary(a.div) 
#             Df Sum Sq Mean Sq F value Pr(>F)
# lineage      1 0.0288 0.02878   1.012  0.317
# treat        1 0.0443 0.04428   1.558  0.216
# Residuals   80 2.2743 0.02843               
...
ggsave(plots.site.t0, filename = "/Users/hannahaichelman/Dropbox/BU/TVE/TVE_Github/DielTempVariability/diversity_plots_site_clean_t0.pdf", width=6,height=6, units=c("in"), useDingbats=FALSE)
